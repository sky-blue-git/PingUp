    ...
    >
      <div className="text-center">
        <img
          ...
          className="aspect-square object-cover rounded-full w-16 shadow-md mx-auto"
          alt=""
        />
      ...
      <div className="flex mt-4 gap-2">
        ...
        <button
          ...
          className="flex items-center justify-center w-16 border text-slate-800 group rounded-md cursor-pointer active:scale-95 transition"
        >
